...
public class BluetoothControlActivity extends Activity {
    ...
    private SeekBar feedback;
    private SeekBar delay1;
    private SeekBar volume2;

    float volume1Value = 0.0f;
    float reverb1Value = 0.0f;
    float feedbackValue = 0.0f;
    float delay1Value = 0.0f;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(CreateActivity.EXTRAS_DEVICE_NAME, mDeviceName);
                intent.putExtra(CreateActivity.EXTRAS_DEVICE_ADDRESS, mDeviceAddress);
        ...
        match.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(MatchActivity.EXTRAS_DEVICE_NAME, mDeviceName);
                intent.putExtra(MatchActivity.EXTRAS_DEVICE_ADDRESS,mDeviceAddress);
                startActivity(intent);
            }
        });
